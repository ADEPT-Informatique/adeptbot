...
class TicketOpeningInteraction(ui.View):
    ...
    async def plainte(self, button: ui.Button, interaction: discord.Interaction):
    ...
    async def moron(self, button: ui.Button, interaction: discord.Interaction):
...
class TicketConfirmationInteraction(ui.View):
    ...
    async def decline(self, button: ui.Button, interaction: discord.Interaction):
